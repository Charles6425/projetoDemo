 ...
 * @author charles
 */
public class ModeloMini extends javax.swing.JFrame {
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelHorario = controllerHorario.getHorarioController(codigo);
    ...
    private void salvar() {
        ...
        salvarAlterar = "novo";
        if (controllerHorario.salvarHorarioController(modelHorario) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerHorario.atualizarHorarioController(modelHorario)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeloMini.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModeloMini().setVisible(true);
            }
        });
    }
