 ...
 * @author charles
 */
public class ViewDiasIntensivo extends javax.swing.JFrame {

    ModelDiasIntensivo modelHorario = new ModelDiasIntensivo();
    ControllerDiasIntensivo controllerHorario = new ControllerDiasIntensivo();
    ArrayList<ModelDiasIntensivo> listaModelHorarios = new ArrayList<>();
    String salvarAlterar;

    /**
     * Creates new form ModeloMini
     */
    public ViewDiasIntensivo() {
        initComponents();
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelHorario = controllerHorario.getDiasIntensivoController(codigo);
    ...
    private void salvar() {
        ...
        salvarAlterar = "novo";
        if (controllerHorario.salvarDiasIntensivoController(modelHorario) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerHorario.atualizarDiasIntensivoController(modelHorario)) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de dias intensivo");
    ...
    private void carregarNcm() {
        listaModelHorarios = controllerHorario.getListaDiasIntensivoController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDiasIntensivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
