 ...
 * @author charles
 */
public class ViewIntensivo extends javax.swing.JFrame {

    ModelIntensivo modelHorario = new ModelIntensivo();
    ControllerIntensivo controllerHorario = new ControllerIntensivo();
    ArrayList<ModelIntensivo> listaModelHorarios = new ArrayList<>();
    String salvarAlterar;

    /**
     * Creates new form ModeloMini
     */
    public ViewIntensivo() {
        initComponents();
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelHorario = controllerHorario.getIntensivoController(codigo);
    ...
    private void salvar() {
        ...
        salvarAlterar = "novo";
        if (controllerHorario.salvarIntensivoController(modelHorario) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerHorario.atualizarIntensivoController(modelHorario)) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Intensivo");
    ...
    private void carregarNcm() {
        listaModelHorarios = controllerHorario.getListaIntensivoController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewIntensivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
