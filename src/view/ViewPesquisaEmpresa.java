 ...
 */
public class ViewPesquisaEmpresa extends javax.swing.JDialog {
     ...
     */
    public ViewPesquisaEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        if (tbAluno.getColumnModel().getColumnCount() > 0) {
            ...
            tbAluno.getColumnModel().getColumn(1).setMinWidth(150);
            tbAluno.getColumnModel().getColumn(1).setPreferredWidth(150);
            tbAluno.getColumnModel().getColumn(1).setMaxWidth(150);
            tbAluno.getColumnModel().getColumn(2).setMinWidth(500);
            tbAluno.getColumnModel().getColumn(2).setMaxWidth(500);
        }
    ...
    private void carregarVendedor() {
        ...
        ArrayList<ModelEmpresa> listamModelEmpresas = new ArrayList<>();
        //listamModelUsuarios = controllerUsuario.getListaUsuarioController();
        listamModelEmpresas = controllerEmpresa.getListaEmpresaController();
        DefaultTableModel modelo = (DefaultTableModel) tbAluno.getModel();
        modelo.setNumRows(0);
        //CARREGA OS DADOS DA LISTA NA TABELA
        int cont = listamModelEmpresas.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listamModelEmpresas.get(i).getId(),
                listamModelEmpresas.get(i).getCodigoEmpresa(),
                listamModelEmpresas.get(i).getRazao()
            });
        }
    }
    ...
    /**
     * charles muller
     * método que tira acentos e deixa com letra maiuscula automaticamente
     */
    private void tirarAcentos() {
        ...
        int cont = listamModelEmpresas.size();
        for (int i = 0; i < cont; i++) {
            modelEmpresa = controllerEmpresa.getEmpresaController(listamModelEmpresas.get(i).getId());
            //System.out.println(listamModelEmpresas.get(i).getRazao().toUpperCase());
            
            modelEmpresa.setRazao(modelEmpresa.getRazao().toUpperCase());

            modelEmpresa.setRazao(blTiraAcentos.TiraAcentos(modelEmpresa.getRazao()));
            controllerEmpresa.atualizarEmpresaController(modelEmpresa);
            System.out.println(modelEmpresa.getRazao());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPesquisaEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewPesquisaEmpresa dialog = new ViewPesquisaEmpresa(new javax.swing.JFrame(), true);
