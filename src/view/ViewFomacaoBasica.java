 ...
 * @author charles
 */
public class ViewFomacaoBasica extends javax.swing.JFrame {
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelFormacaoBasica = controllerFormacaoBasica.getFormacaoBasicaController(codigo);
            //seta os dados na interface
            this.txCodigo.setText(String.valueOf(modelFormacaoBasica.getId()));
            this.txDescricao.setText(modelFormacaoBasica.getDescricao());
            habilitaCampo(true);
    ...
    private void salvar() {
        modelFormacaoBasica.setDescricao(txDescricao.getText());
        salvarAlterar = "novo";
        if (controllerFormacaoBasica.salvarFormacaoBasicaController(modelFormacaoBasica) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerFormacaoBasica.atualizarFormacaoBasicaController(modelFormacaoBasica)) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Formação Básica");
        setAlwaysOnTop(true);
        setResizable(false);
    ...
    private void carregarNcm() {
        ...
        int cont = listaModelFormacaoBasicas.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listaModelFormacaoBasicas.get(i).getId(),
                listaModelFormacaoBasicas.get(i).getDescricao(),});
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFomacaoBasica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
