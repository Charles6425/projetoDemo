 ...
 * @author charles
 */
public class ViewLocalAprendizagem extends javax.swing.JFrame {

    ModelLocalAprendizagem modelHorario = new ModelLocalAprendizagem();
    ControllerLocalAprendizagem controllerHorario = new ControllerLocalAprendizagem();
    ArrayList<ModelLocalAprendizagem> listaModelHorarios = new ArrayList<>();
    String salvarAlterar;

    /**
     * Creates new form ModeloMini
     */
    public ViewLocalAprendizagem() {
        initComponents();
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelHorario = controllerHorario.getLocalAprendizagemController(codigo);
    ...
    private void salvar() {
        ...
        salvarAlterar = "novo";
        if (controllerHorario.salvarLocalAprendizagemController(modelHorario) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerHorario.atualizarLocalAprendizagemController(modelHorario)) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de local de aprendizagem");
    ...
    private void carregarNcm() {
        listaModelHorarios = controllerHorario.getListaLocalAprendizagemController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLocalAprendizagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
