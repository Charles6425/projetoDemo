...
import controller.ControllerAlunoNota;
 ...
 * @author charles
 */
public class ViewAlunoNota extends javax.swing.JFrame {
    ...
    ControllerAlunoNota controllerAlunoNota = new ControllerAlunoNota();
    ArrayList<ModelAluno> listaModelAlunos = new ArrayList<>();
    ArrayList<ModelMateria> listaModelMaterias = new ArrayList<>();
    ArrayList<ModelAlunoNota> listaModelAlunoNotas = new ArrayList<>();
...
//        this.caregaItens();
    ...
    private void caregaNotas() {
        ...
        System.out.println("teste da tela de notas  "+getRgmAluno());
        listaModelAlunoNotas = controllerAlunoNota.getListaAlunoNotaRGMController(getRgmAluno());

        DefaultTableModel modelo = (DefaultTableModel) tbMateria.getModel();

        modelo.setNumRows(0);
        //CARREGA OS DADOS DA LISTA NA TABELA
        int cont = listaModelAlunoNotas.size();
        for (int i = 0; i < cont; i++) {
            //modelMateria = controllerMateria.getMateriaController(listaModelAlunoNotas.get(i).getMateria());
            //modelo.addRow(new Object[]{
            //    listaModelAlunoNotas.get(i).getId(),});
    ...
    private void adicionarProdutoPesquisa(int pCodigoProduto) {
        ...
        ModelMateria modelMateria = new ModelMateria();
        DefaultTableModel modelo = (DefaultTableModel) tbMateria.getModel();
        modelMateria = controllerMateria.getMateriaController(pCodigoProduto);
    ...
    private void preencherTxItens(int pCodigoProduto) {
        ControllerMateria controllerMateria = new ControllerMateria();
        ModelMateria modelMateria = new ModelMateria();
        modelMateria = controllerMateria.getMateriaController(codigoProduto);
    ...
    private void salvar() {
        listaModelAlunoNotas = controllerAlunoNota.getListaAlunoNotaCodController(codPrincipal);
        int cont = tbMateria.getRowCount();

        for (int i = listaModelAlunoNotas.size(); i < cont; i++) {
            modelAlunoNota.setRgm_aluno(txRgm.getText());
            modelAlunoNota.setMateria((int) tbMateria.getValueAt(i, 0));
    ...
    private void initComponents() {
        ...
        btPesquisa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/18x18/Zoom.png"))); // NOI18N
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel4)
                            .addComponent(txItem, javax.swing.GroupLayout.PREFERRED_SIZE, 376, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txNota)
                            .addGroup(jPanel4Layout.createSequentialGroup()
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txItem, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisaActionPerformed
        ViewPesquisaMateria viewPesquisarProduto = new ViewPesquisaMateria(this, rootPaneCheckingEnabled);
        viewPesquisarProduto.setVisible(true);
        codigoProduto = viewPesquisarProduto.getReturnStatus();
        preencherTxItens(codigoProduto);
...
//        caregaItens();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAlunoNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAlunoNota().setVisible(true);
            }
        });
    }
