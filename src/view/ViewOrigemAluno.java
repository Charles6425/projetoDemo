 ...
 * @author charles
 */
public class ViewOrigemAluno extends javax.swing.JFrame {
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelOrigemAluno = controllerOrigemAluno.getOrigemAlunoController(codigo);
            //seta os dados na interface
            this.txCodigo.setText(String.valueOf(modelOrigemAluno.getId()));
            this.txDescricao.setText(modelOrigemAluno.getOrig_descricao());
            habilitaCampo(true);
    ...
    private void salvar() {
        modelOrigemAluno.setOrig_descricao(txDescricao.getText());
        salvarAlterar = "novo";
        if (controllerOrigemAluno.salvarOrigemAlunoController(modelOrigemAluno) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerOrigemAluno.atualizarOrigemAlunoController(modelOrigemAluno)) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Origem de Aluno");
        setResizable(false);
    ...
    private void carregarNcm() {
        ...
        int cont = listaModelOrigemAlunos.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listaModelOrigemAlunos.get(i).getId(),
                listaModelOrigemAlunos.get(i).getOrig_descricao(),});
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOrigemAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
