...
public class ViewCargo extends javax.swing.JFrame {
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelCargo = controllerCargo.getCargoController(codigo);
            //seta os dados na interface
            this.txCodigo.setText(String.valueOf(modelCargo.getId()));
            this.txDescricao.setText(modelCargo.getDescricao());
            habilitaCampo(true);
    ...
    private void salvar() {
        modelCargo.setDescricao(txDescricao.getText());
        salvarAlterar = "novo";
    ...
    private void alterar() {
        ...
        if (controllerCargo.atualizarCargoController(modelCargo)) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Cargo de Aluno");
        setAlwaysOnTop(true);
        setResizable(false);
    ...
    private void carregarNcm() {
        ...
        int cont = listaModelCargos.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listaModelCargos.get(i).getId(),
                listaModelCargos.get(i).getDescricao(),});
        }
    }
