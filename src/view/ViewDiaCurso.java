 ...
 * @author charles
 */
public class ViewDiaCurso extends javax.swing.JFrame {

    ModelDiaCurso modelHorario = new ModelDiaCurso();
    ControllerDiaCurso controllerHorario = new ControllerDiaCurso();
    ArrayList<ModelDiaCurso> listaModelHorarios = new ArrayList<>();
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelHorario = controllerHorario.getDiaCursoController(codigo);
            //seta os dados na interface
            this.txCodigo.setText(String.valueOf(modelHorario.getId()));
            this.txDescricao.setText(modelHorario.getDia());
            habilitaCampo(true);
    ...
    private void salvar() {
        modelHorario.setDia(txDescricao.getText());
        salvarAlterar = "novo";
        if (controllerHorario.salvarDiaCursoController(modelHorario) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerHorario.atualizarDiaCursoController(modelHorario)) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro dia do curso");
    ...
    private void carregarNcm() {
        listaModelHorarios = controllerHorario.getListaDiaCursoController();
        ...
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                ...
                listaModelHorarios.get(i).getDia(),});
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDiaCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
