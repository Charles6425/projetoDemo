 ...
 * @author charles
 */
public class ViewPeriodo extends javax.swing.JFrame {

    ModelPeriodo modelHorario = new ModelPeriodo();
    ControllerPeriodo controllerHorario = new ControllerPeriodo();
    ArrayList<ModelPeriodo> listaModelHorarios = new ArrayList<>();
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelHorario = controllerHorario.getPeriodoController(codigo);
    ...
    private void salvar() {
        ...
        salvarAlterar = "novo";
        if (controllerHorario.salvarPeriodoController(modelHorario) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerHorario.atualizarPeriodoController(modelHorario)) {
    ...
    private void carregarNcm() {
        listaModelHorarios = controllerHorario.getListaPeriodoController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPeriodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
