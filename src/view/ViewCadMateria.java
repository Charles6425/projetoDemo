 ...
 * @author charles
 */
public class ViewCadMateria extends javax.swing.JFrame {
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            modelMateria = controllerMateria.getMateriaController(codigo);
            //seta os dados na interface
            this.txCodigo.setText(String.valueOf(modelMateria.getId()));
            this.txDescricao.setText(modelMateria.getDescricao());
            habilitaCampo(true);
    ...
    private void salvar() {
        modelMateria.setDescricao(txDescricao.getText());
        salvarAlterar = "novo";
        if (controllerMateria.salvarMateriaController(modelMateria) > 0) {
    ...
    private void alterar() {
        ...
        if (controllerMateria.atualizarMateriaController(modelMateria)) {
    ...
    private void txDescricaoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txDescricaoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txDescricaoKeyPressed
    ...
    private void carregarNcm() {
        listaModelMateria = controllerMateria.getListaMateriaController();
        DefaultTableModel modelo = (DefaultTableModel) tbDescricao.getModel();
        modelo.setNumRows(0);
        //CARREGA OS DADOS DA LISTA NA TABELA
        int cont = listaModelMateria.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listaModelMateria.get(i).getId(),
                listaModelMateria.get(i).getDescricao(),});
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCadMateria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
