...
public class ModelContaReceber {
    ...
    public String toString() {
        return "ModelContaReceber{" + "codigo=" + codigo + ", codigoPessoa=" + codigoPessoa + ", descricao=" + descricao + ", data=" + data + ", vencimento=" + vencimento + ", pagamento=" + pagamento + ", tipoPagamento=" + tipoPagamento + ", observacao=" + observacao + ", situacao=" + situacao + ", pedido=" + pedido + ", valor=" + valor + '}';
    }
